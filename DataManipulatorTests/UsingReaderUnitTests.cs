...
namespace DataManipulatorTests
{
    ...
    public class UsingReaderUnitTests
    {
        ...
        public void TestingTestData()
        {
            ...
            // arrange
            var data = testDataReader.GetData();

            // assert
            Assert.AreEqual(data.Count(), 100, "There should be 100 items in the test data");
        }

        [TestMethod]
        public void TestingGroupedNum1Reader()
        {
            // assign
            var reader = new TestDataReader();
            var converter = new TestDataConverter(v => v.Num1);
            var dm = new DataManipulator<InitialValues, FinalValues, DateTime>(reader, converter);
        ...
        [TestMethod]
        public void TestingGroupedNum2Reader()
        {
            // assign
            var reader = new TestDataReader();
        ...
        [TestMethod]
        public void TestingGroupedNum3Reader()
        {
            // assign
            var reader = new TestDataReader();
        ...
        [TestMethod]
        public void TestAverageNum1Reader()
        {
            // assign
            var reader = new TestDataReader();
            var converter = new TestDataConverter(v => v.Num1);
        ...
        [TestMethod]
        public void TestAverageNum2Reader()
        {
            // assign
            var reader = new TestDataReader();
            var converter = new TestDataConverter(v => v.Num2);
        ...
        [TestMethod]
        public void TestAverageNum3Reader()
        {
            // assign
            var reader = new TestDataReader();
            var converter = new TestDataConverter(v => v.Num3);
        ...
        [TestMethod]
        public void TestAverageGroupSizeReader()
        {
            // assign
            var reader = new TestDataReader();
            var converter = new TestDataConverter(v => v.Num3);
